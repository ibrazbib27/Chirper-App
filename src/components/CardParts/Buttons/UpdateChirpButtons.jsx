...
<Row className="w-100  justify-content-around p-0">
    <Col xs={12} md={5} className="order-2 order-md-0 p-0">
        <Button className="w-100 px-2 px-md-0" variant="danger"  onClick={()=>{
                props.func(false);
                alert("Your chirper has now been successfully deleted from your timeline.");
                props.close();
                }
            }>
            Delete Chirp
    ...
    <Col xs={12} md={5} className="order-1 order-md-0  mb-2 mb-md-0 p-0">
          <Button className="w-100 px-2 px-md-0" variant="success"  onClick={()=>{
                props.func(true);
                alert("Your chriper information has been successfully been updated.");
                props.close();
                }
    }>
            Save Changes
