...
function renderPicTooltip(props) {
  return (
    <Tooltip id="button-tooltip" {...props}>
      ...
      .jpg, .jpeg, and .png. Entry of a url that does not meet the following
      requirements will be disregarded. If you wish to revert back to the
      default question mark image enter "default" with no extra characters.
      Lastly, if you wish to keep the image the way it is, just leave the 'Image
      url' field blank.
    </Tooltip>
  );
}
  ...
  let handleUpload = () => {
    ...
    if (imgUrl.toUpperCase() === "DEFAULT") {
      ...
      if (
        ...
        if (props.modal === true)
          document.getElementById("modal").getElementsByTagName("img")[0].src =
