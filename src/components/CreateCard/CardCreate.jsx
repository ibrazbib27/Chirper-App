...
class CardCreate extends Component {
      ...
      cardDetails: [
        {
          ...
          header: "Grasshopper",
          img:
            "https://www.clker.com/cliparts/4/1/f/8/1516193030290013696free-clipart-grasshopper.med.png",
          message:
            "I am a grasshopper and I like to chirp really loud at night",
        },
        {
          id: 1,
          header: "Frog",
          img:
            "https://www.pngitem.com/pimgs/m/459-4591591_transparent-frogs-clipart-clipart-frog-hd-png-download.png",
          message: "I am a Frog and I chirp louder than a Grasshopper",
        },
        {
          id: 2,
          header: "Kid",
          img:
            "https://www.pngitem.com/pimgs/m/406-4061238_png-pinterest-clip-kids-clipart-boy-transparent-png.png",
          message: "I am a kid and I wish I can chirp",
        },
      ],
    };
  ...
  updateCard(id, header, img, msg, update) {
    ...
    for (let num = 0; num < arr.length; num++) {
      document
        .getElementById(parseInt(arr[num].id))
        .getElementsByTagName("img")[0].src = arr[num].img;
    }
    if (update === true) {
  ...
  handleClick() {
    ...
    setTimeout(() => {
      alert(
        "Success: Congratulations, you have updated a new chirp to your timeline! You can view your timeline by clicking the 'Home' button."
      );
      ...
      <React.Fragment>
        {this.props.newCard ? (
          <InputCard
            ...
            myId={this.state.cardDetails}
          />
        ) : (
          <OutputCard func={this.updateCard} cards={this.state.cardDetails} />
        )}
      </React.Fragment>
    );
  }
