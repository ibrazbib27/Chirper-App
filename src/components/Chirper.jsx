      ...
      <React.Fragment>
        ...
        >
          ...
          <Navbar.Collapse id="responsive-navbar-nav">
            <Nav
              id="mainnav"
              className="ml-auto w-50 d-none d-md-flex justify-content-md-between"
            >
              <Nav.Link
                className="HomeCl"
                onClick={(e) => {
                  e.preventDefault();
                  document.getElementsByClassName("HomeCl")[1].click();
                }}
                onMouseUp={this.renderChriperPg}
                href="Home"
              >
                Home
              </Nav.Link>
              ...
              <Nav.Link
                ...
                onClick={(e) => {
                  e.preventDefault();
                  document.getElementsByClassName("AboutCl")[1].click();
                }}
                href="About"
              >
                About
              ...
              <Nav.Link
                ...
                onClick={(e) => {
                  e.preventDefault();
                  document.getElementsByClassName("AddCl")[1].click();
                }}
                onMouseUp={this.addNewChriperPg}
                href="Add"
              >
                Add New Chirper
              </Nav.Link>
            ...
            >
              <Navbar.Toggle />
              <Nav.Link
                className=" mb-2 mt-auto HomeCl  border border-white mx-3"
                href="Home"
                onClick={(e) => {
                  e.preventDefault();
                  document.getElementsByClassName("HomeCl")[0].click();
                }}
                onMouseUp={this.renderChriperPg}
              >
                Home
              ...
              <Nav.Link
                className=" mb-2 AboutCl border border-white mx-3"
                href="About"
                onClick={(e) => {
                  e.preventDefault();
                  document.getElementsByClassName("AboutCl")[0].click();
                }}
              >
                About
              </Nav.Link>
              ...
              <Nav.Link
                className="mb-2 AddCl border border-white mx-3 mb-4"
                href="Add"
                onClick={(e) => {
                  e.preventDefault();
                  document.getElementsByClassName("AddCl")[0].click();
                }}
                onMouseUp={this.addNewChriperPg}
              >
                Add New Chirper
